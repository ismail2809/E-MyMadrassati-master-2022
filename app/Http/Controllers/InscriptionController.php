...
class InscriptionController extends Controller
{
	...
	public function create(){
        $années = Année::all();
        $classes = Classe::all();
        $catégories = Categorie::groupBy('titre')->get(); 
    ...
    public function edit($id){
        ...
        //dd($user);
        return view('inscription.edit',compact('années','classes','catégories','inscription','user','etudiant'));
    }
    ...
    public function detailEtudiant($id){
        ...
        $user = json_decode(User::where('id',$etudiant['user_id'])->first(),true); 
        ...
        */
        ...
        $detail['user']= isset($user)?$user:'';                               
        $detail['annee']= isset($annee)?$annee:'';                                  
        $detail['categorie']= isset($categorie)?$categorie:'';                           
        //$detail['niveau']= isset($niveau)?$niveau:'';                               
        $detail['classe']= isset($classe)?$classe:'';  
        $detail['historiquePayements']= isset($historiquePayements)?$historiquePayements:'';  
        //$detail['historiqueAbsences']= $historiqueAbsences;  
        //$detail['historiqueNotes']= $historiqueNotes;  
        $detail['sum_payement']= isset($sum_payement)?$sum_payement:'';  
