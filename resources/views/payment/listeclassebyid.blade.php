	    ...
	    <div class="card-body">
	      ...
	      <div class="material-datatables"> 
	        ...
	        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
	          ...
	          <tbody>
	            @foreach($payment_classe as $payment)
	            <tr>
	              ...
	              <td>{{ isset($payment['created_at'])?$payment['created_at']:$payment['created_at'] }}</td> 
	              <td class="td-actions text-center">
	               	<a href="{{url('/payment/add/'.$payment['id'])}}"  class="btn btn-info btn-round" title="détail"><i class="material-icons">remove_red_eye</i> 
                  	</a> 
                  </td>              
	            </tr>
	            </tr>              
