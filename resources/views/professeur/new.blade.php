		  ...
		  <div class="col-md-12">
		    ...
		    <div class="card-body">             
		        ...
		        <div class="row">
		          ...
		          <div class="col-sm-4">
		            <div class="form-group">
		              <input type="text" class="form-control" name="cin" placeholder="CIN" autocomplete="off">
		            </div>
		          </div>
		        </div> 
		        ...
		        <div class="row">
		          ...
		          <div class="col-sm-4">
		            <div class="form-group">
		              <input type="text" class="form-control" name="diplome" placeholder="diplome" autocomplete="off">
		            </div>
		          </div>
		        </div> 
		        ...
		        <div class="row">
		          ...
		          <div class="col-sm-4">
		            <div class="form-group">
		              <input type="text" class="form-control" name="promo" placeholder="Promo" autocomplete="off">
		            </div>
		          </div>
		        </div>  
