	...
	<div class="col-md-12">
	  <div class="card">
	    <div class="card-header card-header-success card-header-icon">
	      ...
	      <h4 class="card-title">Ajouter agent</h4>
	    </div>
	    <div class="card-body">
		  <div class="col-md-12">
		     <form method="post" action="{{url('/store_agent')}}" class="form-horizontal">         
		     {{ csrf_field() }}  
		     <input type="hidden" value="agent" name="role">
		    <div class="card-body">       

		    		<div class="row">  
						    <label for="exampleFormControlSelect2" class="col-sm-2 col-form-label">Role</label>
						    <div class="col-sm-4">
			            <div class="form-group"> 
							    <select multiple class="form-control selectpicker" name="roles[]" data-style="btn btn-link" id="exampleFormControlSelect2"  >
